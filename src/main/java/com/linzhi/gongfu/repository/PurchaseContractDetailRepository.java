...
import com.linzhi.gongfu.entity.PurchaseContractDetail;
...
public interface PurchaseContractDetailRepository
    extends CrudRepository<PurchaseContractDetail, String>, QuerydslPredicateExecutor<PurchaseContractDetail> {
     ...
     */
    @Modifying
    @Query(value = "update PurchaseContractDetail c set c.state=?1 where c.id=?2")
