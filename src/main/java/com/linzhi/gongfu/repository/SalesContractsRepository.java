...
public interface SalesContractsRepository
    ...
    @Query(value = "select" +
        ...
        ",d.buyer_order_code as customerContractNo ,b.buyer_comp_name as buyerCompName," +
        ...
        " where b.created_by_comp=?1 and b.created_by=?2 and b.state =?3   group by  b.id,b.code,d.revision,d.order_code,o.code,o.name, b.created_at,b.state,p.id,d.buyer_order_code ,b.buyer_comp_name,d.total_price_vat,d.confirm_total_price_vat \n",nativeQuery = true )
    ...
    @Query(value = "select " +
        ...
        "left join sales_contract_record_temp t on t.contract_id = d.id " +
        "left join purchase_contract_base p on b.paired_code=p.paired_code" +
        " where b.created_by_comp=?1  and b.state =?2   group by  b.id,b.code,d.revision,d.order_code,o.code,o.name, b.created_at,b.state,p.id,d.buyer_order_code ,b.buyer_comp_name,d.total_price_vat,d.confirm_total_price_vat \n",nativeQuery = true )
